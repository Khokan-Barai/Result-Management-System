...
<head>
	<meta charset="UTF-8">
	<title>Put Semister for Delete Result</title>
...
<!---End icon-bar--->
	<h1 class="toptext">The Result Delete Section</h1>
	<h1 class="textsection1">Select Semister For Delete The Result</h1>
	<br /><br />
	<form class="insert_from" action="delete_case.php" method="post">
