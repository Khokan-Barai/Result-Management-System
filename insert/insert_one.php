...
<head>
	<meta charset="UTF-8">
	<title>One Semister Result Insert</title>
...
<!---Insert section---->
<br><br>
	<form action="insert_one_code" method="post">
		<table>
		<tr>
			<th>Roll</th>
			<th>Batch</th>
		...
		<tr>
			...
			<td><input class="inputfild" type="text" name="cse101" placeholder="CSE-101" required></td>
			<td><input class="inputfild" type="text" name="phy101" placeholder="PHY-101" required></td>
			<td><input class="inputfild" type="text" name="ged101" placeholder="GED-101" required></td>
			<td><input class="inputfild" type="text" name="ged102" placeholder="GED-102" required></td>
