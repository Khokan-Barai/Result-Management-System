...
<head>
	...
	<title>Eight Semister Result Insert</title>
		<!---icon-bar--->
...
<!---Insert section---->
	<br><br>
	<form action="insert_eight_code" method="post">
		<table>
		<tr>
			<th>Roll</th>
			<th>Batch</th>
		...
		<tr>
			...
			<td><input class="inputfild" type="text" name="cse305" placeholder="CSE-305" required></td>
			<td><input class="inputfild" type="text" name="cse306" placeholder="CSE-306" required></td>
			<td><input class="inputfild" type="text" name="cse307" placeholder="CSE-307" required></td>
			<td><input class="inputfild" type="text" name="cse308" placeholder="CSE-308" required></td>
			<td><input class="inputfild" type="text" name="cse313" placeholder="CSE-313" required></td>
