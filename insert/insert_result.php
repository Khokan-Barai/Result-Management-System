...
<head>
	<meta charset="UTF-8">
	<title>Put Semister for Result Insert</title>
		<!---icon-bar--->
...
<!---End icon-bar--->
	<h1 class="toptext">The Result Insert Section</h1>
	<h1 class="textsection1">Select Semister For Insert The Result</h1>
	<br /><br />
	<form class="insert_from" action="insert_case.php" method="post">
		<select class="inputsubmit" name="dropdownlist_i" required>
