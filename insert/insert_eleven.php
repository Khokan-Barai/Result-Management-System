...
<head>
	...
	<title>Eleven Semister Result Insert</title>
		<!---icon-bar--->
...
<br><br>
	...
	<form action="insert_eleven_code" method="post">
		<table>
		<tr>
			<th>Roll</th>
			<th>Batch</th>
		...
		<tr>
			...
			<td><input class="inputfild" type="text" name="cse405" placeholder="CSE-405" required></td>
			<td><input class="inputfild" type="text" name="cse406" placeholder="CSE-406" required></td>
			<td><input class="inputfild" type="text" name="cse407" placeholder="CSE-407" required></td>
			<td><input class="inputfild" type="text" name="cse408" placeholder="CSE-408" required></td>
			<td><input class="inputfild" type="text" name="cse411" placeholder="CSE-411" required></td>
