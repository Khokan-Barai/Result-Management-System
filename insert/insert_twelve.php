...
<head>
	<meta charset="UTF-8">
	<title>Twelve Semister Result Insert</title>
...
<br><br>
	...
	<form action="insert_twelve_code" method="post">
		<table>
		<tr>
			<th>Roll</th>
			<th>Batch</th>
		...
		<tr>
			...
			<td><input class="inputfild" type="text" name="cse413" placeholder="CSE-413" required></td>
			<td><input class="inputfild" type="text" name="cse414" placeholder="CSE-414" required></td>
			<td><input class="inputfild" type="text" name="cse425" placeholder="CSE-425" required></td>
