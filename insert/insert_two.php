...
<head>
	<meta charset="UTF-8">
	<title>Two Semister Result Insert</title>
...
<!---Insert section---->
<br><br>
	<form action="insert_two_code" method="post">
		<table>
		<tr>
			<th>Roll</th>
			<th>Batch</th>
		...
		<tr>
			...
			<td><input class="inputfild" type="text" name="cse103" placeholder="CSE-103" required></td>
			<td><input class="inputfild" type="text" name="cse104" placeholder="CSE-104" required></td>
			<td><input class="inputfild" type="text" name="phy103" placeholder="PHY-103" required></td>
			<td><input class="inputfild" type="text" name="phy104" placeholder="PHY-104" required></td>
			<td><input class="inputfild" type="text" name="eng101" placeholder="ENG-101" required></td>
			<td><input class="inputfild" type="text" name="math101" placeholder="MATH-101" required></td>
