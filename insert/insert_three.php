...
<head>
	<meta charset="UTF-8">
	<title>Three Semister Result Insert</title>
...
<!---Insert section---->
<br><br>
	<form action="insert_three_code" method="post">
		<table>
		<tr>
			<th>Roll</th>
			<th>Batch</th>
		...
		<tr>
			...
			<td><input class="inputfild" type="text" name="cse105" placeholder="CSE-105" required></td>
			<td><input class="inputfild" type="text" name="cse106" placeholder="CSE-106" required></td>
			<td><input class="inputfild" type="text" name="chem101" placeholder="CHEM-101" required></td>
			<td><input class="inputfild" type="text" name="chem102" placeholder="CHEM-102" required></td>
			<td><input class="inputfild" type="text" name="eng102" placeholder="ENG-102" required></td>
			<td><input class="inputfild" type="text" name="math102" placeholder="MATH-102" required></td>
