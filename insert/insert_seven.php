...
<head>
	<meta charset="UTF-8">
	<title>Seven Semister Result Insert</title>
...
<!---Insert section---->
<br><br>
	<form action="insert_seven_code" method="post">
		<table>
		<tr>
			<th>Roll</th>
			<th>Batch</th>
		...
		<tr>
			...
			<td><input class="inputfild" type="text" name="cse301" placeholder="CSE-301" required></td>
			<td><input class="inputfild" type="text" name="cse302" placeholder="CSE-302" required></td>
			<td><input class="inputfild" type="text" name="cse303" placeholder="CSE-303" required></td>
			<td><input class="inputfild" type="text" name="cse304" placeholder="CSE-304" required></td>
			<td><input class="inputfild" type="text" name="eee301" placeholder="EEE-301" required></td>
			<td><input class="inputfild" type="text" name="ged301" placeholder="GED-301" required></td>
