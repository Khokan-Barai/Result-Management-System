...
<head>
	<meta charset="UTF-8">
	<title>Ten Semister Result Insert</title>
...
<br><br>
	...
	<form action="insert_ten_code" method="post">
		<table>
		<tr>
			<th>Roll</th>
			<th>Batch</th>
		...
		<tr>
			...
			<td><input class="inputfild" type="text" name="cse401" placeholder="CSE-401" required></td>
			<td><input class="inputfild" type="text" name="cse402" placeholder="CSE-402" required></td>
			<td><input class="inputfild" type="text" name="cse403" placeholder="CSE-403" required></td>
			<td><input class="inputfild" type="text" name="cse404" placeholder="CSE-404" required></td>
			<td><input class="inputfild" type="text" name="cse409" placeholder="CSE-409" required></td>
			<td><input class="inputfild" type="text" name="cse410" placeholder="CSE-410" required></td>
