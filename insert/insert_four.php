...
<head>
	<meta charset="UTF-8">
	<title>Four Semister Result Insert</title>
...
<!---Insert section---->
<br><br>
	<form action="insert_four_code" method="post">
		<table>
		<tr>
			<th>Roll</th>
			<th>Batch</th>
		...
		<tr>
			...
			<td><input class="inputfild" type="text" name="cse201" placeholder="CSE-201" required></td>
			<td><input class="inputfild" type="text" name="eee201" placeholder="EEE-201" required></td>
			<td><input class="inputfild" type="text" name="eee202" placeholder="EEE-202" required></td>
			<td><input class="inputfild" type="text" name="ged201" placeholder="GED-201" required></td>
			<td><input class="inputfild" type="text" name="math201" placeholder="MATH-201" required></td>
