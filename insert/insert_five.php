...
<head>
	...
	<title>Five Semister Result Insert</title>
		<!---icon-bar--->
...
<!---Insert section---->
<br><br>
	<form action="insert_five_code" method="post">
		<table>
		<tr>
			<th>Roll</th>
			<th>Batch</th>
		...
		<tr>
			...
			<td><input class="inputfild" type="text" name="cse203" placeholder="CSE-203" required></td>
			<td><input class="inputfild" type="text" name="cse204" placeholder="CSE-204" required></td>
			<td><input class="inputfild" type="text" name="cse205" placeholder="CSE-205" required></td>
			<td><input class="inputfild" type="text" name="cse206" placeholder="CSE-206" required></td>
			<td><input class="inputfild" type="text" name="math202" placeholder="MATH-202" required></td>
