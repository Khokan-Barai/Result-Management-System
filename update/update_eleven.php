...
<head>
	<meta charset="UTF-8">
	<title>Eleven Semister Result Update</title>
...
<!---End icon-bar--->
	<h1 class="toptext">Please Put Value For Update The Result</h1>
<!---Update section---->
<br><br>
	<form action="update_eleven_code" method="post">
		<table>
		<tr>
			<th>Roll</th>
			<th>Batch</th>
		...
		<tr>
			...
			<td><input class="inputfild" type="text" name="subcode" placeholder="Like: cse101" required></td>
			<td><input class="inputfild" type="text" name="value" placeholder="Result" required></td>
			
		</tr>
		
		</table>
		<input class="inputsubmit" type="submit" name="" value="Update">
		<a class="gobtn" href="update_result.php">Go Back</a>
	</form>
